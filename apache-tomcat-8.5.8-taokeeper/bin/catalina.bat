...
set "JAVA_OPTS=%JAVA_OPTS% -DconfigFilePath=G:\app_server\apache-tomcat-8.5.8-taokeeper-monitor\webapps\taokeeper-monitor\config\taokeeper-monitor-config.properties"
